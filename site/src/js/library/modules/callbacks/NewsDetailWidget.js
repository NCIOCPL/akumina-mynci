// Rename in future
// NewsDetailWidget_ui
const newsDetail_ui_prepSlider = function (_widget, _props) {
...
const newsDetail_data_addContactInfo = function (data) {
  var profInfo1 = $('#profInfoLink1');
  var profInfo2 = $('#profInfoLink2');
  var profPhoto1 = $('#profPhotoLink2');
  var profPhoto2 = $('#profPhotoLink2');
...
export const newsDetailWidget_callbacks = {
  newsDetail_ui_prepSlider,
  newsDetail_data_addContactInfo
}
