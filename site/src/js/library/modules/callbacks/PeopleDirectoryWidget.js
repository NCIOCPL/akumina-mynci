...
const tab_html_prepOrgTabs = function (_control, _properties) {
...
const genericItem_data_setOrgDescription = function (prop) {
...
const genericSearchList_query_setOrgSearch = function (request) {
...
const genericSearchList_data_searchOrgs = function (data) {
  data.SearchTerm =
...
const peopleDirectory_html_loadOrgs = function () {
  ...
  FireWhen(
    ...
    function () {
      ...
      // This is a hack that someone put in to add 'truncate' to elements that were delayed, I guess
      // It was assigned to a var but never cleared: clearInterval(truncateTimmer);
      // Leaving the code just in case we actually need it.
...
//OrganizationDirectoryPage
const peopleDirectory_ui_addOrgDirTabs = function () {
  FireWhen(
...
const peopleDirectory_html_loadTabs = function () {
  FireWhen(
    'LoadTabWidget',
    function () {
      return (
...
export const peopleDirectoryWidget_callbacks = {
  tab_html_prepOrgTabs,
  genericItem_data_setOrgDescription,
  genericSearchList_query_setOrgSearch,
  genericSearchList_data_searchOrgs,
  peopleDirectory_html_loadOrgs,
  peopleDirectory_ui_addOrgDirTabs,
  peopleDirectory_html_loadTabs
}
